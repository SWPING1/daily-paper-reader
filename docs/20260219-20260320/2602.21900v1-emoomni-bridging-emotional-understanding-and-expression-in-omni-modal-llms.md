...
method: 引入情感思维链（E-CoT）机制，通过从细粒度感知到文本响应的推理过程，显式引导模型的情感理解与语音表达。
result: 实验显示EmoOmni-7B在相同Talker配置下，其性能可与参数量更大的Qwen3Omni-30B-A3B-Thinking相媲美。
conclusion: EmoOmni通过显式情感推理和高质量数据集，有效提升了全模态模型在多模态情感对话中的理解与表达一致性。
---
